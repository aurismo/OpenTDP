...
class ProcessStep:
    id: str = ""
    sequence: int = 0
    sequence_letter: str = ""   # Distinguishes steps performed in parallel at the same sequence number
    name: str = ""
    description: str = ""
    ...
    def from_xml_dict(d: dict) -> "ProcessStep":
        return ProcessStep(
            ...
            sequence_letter=d.get("sequence_letter", ""),
            name=d.get("name", ""),
...
@dataclass
class ProcessOption:
    id: str = ""                # stable identifier, used for archive folder naming
    option_name: str = ""
    description: str = ""
    maturity: str = ""
